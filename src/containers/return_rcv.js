...
class ReturnData extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      logShow: false,
      id_rcv:"",
      sortList: ["Start With Rcv", "Start with (Not) Rcv"],
      k_val:0,
      s: 0,
      i: 0,
      del_reason: "",
...
sortFilter = () => {
  ...
  row = (k) => {
    ...
    if (this.state.clickCount == 0) {
      //console.log("State Count: ", this.state.clickCount)
        ...
        {this.state.showTable == true ? (
          <div style={{textAlign: "center"}}>
            ...
            onClick={() => {
              ...
              if (this.state.clickCount == 1) {
                this.setState({ clickCount: 0, render1:true });
              } else {
                this.setState({ clickCount: 1, render1:true });
              }
            }}
